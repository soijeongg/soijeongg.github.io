...
fast campus 인강 중 10개 프로젝트로 완성하는 백엔드 웹개발(Java/Spring) 초격차 패키지 Online를 사놨었는데 여기 카프카가 있었다 
근데 여기 리액트 네이티브와 xcode는 내가 샀는데 리액트는 왜 사놨지> 데브옵스 살껄
### 도입배경
...
![](https://velog.velcdn.com/images/soijeongg/post/4645b568-f65f-41bb-9d96-e9bf95ffc989/image.png)

시스템이 복잡해짐에 따라 이를 운영하고 개발은 매우 복잡해짐
서로 각각 시스템 끼리의 연결이 엉켜있음
![](https://velog.velcdn.com/images/soijeongg/post/4639bef1-b068-44e9-8c0e-b8ea2e5f59a1/image.png)
이런 문제를 해결하기 위해 kafka가 만들어졌다 
모든 시스템은 카프카를 타켓으로 대이터를 송신하는 구조 
![](https://velog.velcdn.com/images/soijeongg/post/68534262-0080-483b-835c-70f7b7b80b3e/image.png)
...
걱 콘슈머 그룹은 특정 토픽의 파팃션에ㅐ서 데이터를 소비하는 역할
