...
image: https://velog.velcdn.com/images/soijeongg/post/3429a3d5-3929-4796-8d9f-74ddea8062bd/image.jpg
tags: 
    - coding
    - diary
    - hh99
...
### 바꿀것
1. node-alpline으로 빌드 후 한단계씩 올리기 
2. Docker 멀티 스테이지 빌드
3. aws ECR 사용해보기
...
멀티 스테이지 빌드는 Dockerfile에서 여러 개의 FROM 지시문을 사용하여 여러 단계의 이미지 빌드를 수행하는 기술
 각 단계마다 다른 이미지를 사용하여 필요한 의존성을 포함하고 실행 파일을 빌드하거나 복
