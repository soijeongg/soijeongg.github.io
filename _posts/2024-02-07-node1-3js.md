...
read_time: true
show_date: true
title: "[항해99]js문법 종합반 3주차"
date: 2024-02-07 15:00:20 -0600
description: "[항해99]js문법 종합반 3주차"
...
![](https://image.yes24.com/goods/78586788/XL)
코어자바스크립트 01.데이터 타입 부분

### 데이터 타입 심화
자바스크립트에서 값의 타입은 기본형과 참조형으로 구분
![](../assets/img/uploads/datatyoe.png)
- 기본형
...
어쨌든 이런 식별자의 유효범위를 안에서부터 바깥으로 차례대로 검색해 나가는 것을 스코프 체인이라고 함![](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJyNR4O9w4abbWqH0_HofP8OZf6gzRVfO8ww&s)
...
3.call / apply 메서드 활용
유사배열객체(array-like-object)에 배열 메서드를 적용![](../assets/img/uploads/arrays.png)
```javascript
